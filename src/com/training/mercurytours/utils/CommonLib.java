...
public class CommonLib {
	...
	protected static Logger logger=Logger.getLogger(CommonLib.class);
	...
	public static String openBrowser(String sBrowserName) {
		try {
			...
			logger.info(sBrowserName+"Browser launched successfully");
			return "Pass";
	
		} catch (Throwable t) {
			System.out.println("Unable to launch "+sBrowserName+" browser");
			takeScreenshot("OpenBrowser.png");
			logger.error(sBrowserName+"Browser failed to launched");
			return "Failed"; 
		}
	...
	public static String closeBrowser() {
		...
		catch(Throwable t)
		{
			...
			logger.info("Failed to Close browser");
			return "Fail";
		}
	}
	...
	public static void selectValFromListbox(WebElement oElem,String sVal)
	{
		try
		{
			...
			logger.info("Select the value "+sVal+"from list box");
		}
		catch(Throwable t)
		{
			System.out.println(t.getMessage());
			logger.error("Failed to Select the value "+sVal+"from list box");
	...
	public static void enterText(By oBy,String sVal)
	{
		try
		{
			...
			logger.info("Entered the text "+sVal+"successfully");
		...
		catch(Throwable t)
		{
			...
			logger.error("Unable to Enter the text "+sVal+"into text box due to "+t.getMessage());
		}
	}
	...
	public static void clickElem(By oBy)
	{
		try
		{
			...
			logger.info("Clicked on Elem successfully");
		}
		catch(Throwable t)
		{
			takeScreenshot("ClickElem.png");
			System.out.println(t.getMessage());
			logger.error("Failed to click on Elem ");
		}
	}
	...
	{
		logger.info("Creating WebElement instance");
